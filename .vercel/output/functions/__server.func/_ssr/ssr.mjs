...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-4MmncEjZ.mjs");
...
var manifest = {
	"0a085f52246af7785ce26eaf1bcb79dbe1a08e97de6d29e630dcafc1512305d9": {
		functionName: "updateLeadStatus_createServerFn_handler",
		importer: () => import("./leads-BBH8Vq8Z.mjs")
	},
	"297196135f1ef6e4262f70a63d6f2579e6e6fa74c0e09cd1a79f8a2b49ac985a": {
		functionName: "listFieldTests_createServerFn_handler",
		importer: () => import("./leads-BBH8Vq8Z.mjs")
	},
	"3dc8e31fa88b1dff6399a16c1b404cac83668675ea6695ebd1394717d5fdafa7": {
		functionName: "issueVerify_createServerFn_handler",
		importer: () => import("./leads-BBH8Vq8Z.mjs")
	},
	"5e19cdc99b1e2ed6d6106ce5471cc7ab5da3dc124aec77517748fdedd2c609dc": {
		functionName: "listVerify_createServerFn_handler",
		importer: () => import("./leads-BBH8Vq8Z.mjs")
	},
	"710a0c72cf528a7ae36d8c7b6e9c8915768b29984f013e44745897018b29d348": {
		functionName: "lookupVerify_createServerFn_handler",
		importer: () => import("./leads-BBH8Vq8Z.mjs")
	},
	"9b75fe69c2063078843665788ad6fbd0ce3603f56f2026930061b732b80bc0f5": {
		functionName: "listAnalysis_createServerFn_handler",
		importer: () => import("./leads-BBH8Vq8Z.mjs")
	},
	"e714064bd8691167da7a8e629001026ba6c81c684e30cfec97c05f01238846df": {
		functionName: "saveFieldTest_createServerFn_handler",
		importer: () => import("./leads-BBH8Vq8Z.mjs")
	},
	"ef58acdc34bc43d29e02d9d015cbda1130698fb160464792c0143aefe1c7061b": {
		functionName: "submitAnalysis_createServerFn_handler",
		importer: () => import("./leads-BBH8Vq8Z.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C0ObC0ak.mjs").then((n) => n.t),
